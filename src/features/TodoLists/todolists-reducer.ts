...
export type TodoListThunkT<ReturnType = void> = ThunkAction<ReturnType,
    AppRootStateT,
    unknown,
    ActionsT | setAppStatusAT | setAppSuccessAT>;

type SagaTodoListActionsT = {
    FETCH_TODOLIST: "SAGA/TODOLIST/FETCH-TODOLIST"
}
...
export const sagaTodoListActions: SagaTodoListActionsT = {
    FETCH_TODOLIST: "SAGA/TODOLIST/FETCH-TODOLIST"
}
...
export function* todoListWatcher() {
    yield takeEvery(sagaTodoListActions.FETCH_TODOLIST, fetchTodoListsWatcher);
}
...
export const fetchTodoListsSA = () => ({type: sagaTodoListActions.FETCH_TODOLIST})
